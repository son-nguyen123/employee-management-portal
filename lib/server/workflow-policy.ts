...
export const workflowPolicy = {
  ...
  scheduleLatePenalty: envNumber('PENALTY_LATE_SCHEDULE_AMOUNT', 50_000),
  leaveNoticeHours: envNumber('LEAVE_NOTICE_HOURS', 24, 1),
  leaveLatePenalty: envNumber('PENALTY_LATE_LEAVE_AMOUNT', 50_000),
  lateNoticeMinutes: 60,
  lateNoticePenalty: envNumber('PENALTY_LATE_NOTICE_AMOUNT', 1_000),
}
